# rMAB algorithm
This is the repository for the rMAB algorithm used in paper "Bias, Regret and Statistical Inference in Adaptive Data Collection" by Tong Wang, Bo Ji, and Zhigen Zhao. 
Details see (archive website)

Code tested on Python 3.9 requires Numpy, Scipy, and Pandas.
